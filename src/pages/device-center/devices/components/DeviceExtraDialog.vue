...
import type { DeviceExtra } from "@/common/apis/devices/type"
import { ElMessage } from "element-plus"
import { cloneDeep } from "lodash-es"
import { ref } from "vue"
import { getDeviceByIdApi, updateDeviceExtraApi } from "@/common/apis/devices"
...
const defaultForm: DeviceExtra = {
  id: undefined
}

const loading = ref(false)
const formData = ref<DeviceExtra>(cloneDeep(defaultForm))
const inputTag = ref("")
...
async function handleSubmit() {
  ...
  loading.value = true
  try {
    const submitData: DeviceExtra = {
      ...formData.value,
      id: props.deviceId
    }
    await updateDeviceExtraApi(submitData)
      ...
      <el-form :model="formData" label-width="100px">
        <el-tabs type="border-card">
          <el-tab-pane label="基础配置">
            <el-form-item prop="tags" label="设备标签">
